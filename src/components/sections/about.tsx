        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <motion.h2 {...fadeUp(0.15)} className="text-4xl lg:text-5xl font-black leading-tight">
              ABOUT{" "}
              <span className="text-[#e53e3e]">ME</span>
            </motion.h2>
            ...
            <motion.p {...fadeUp(0.25)} className="text-white/60 text-base leading-relaxed">
              AI Automation Expert &amp; Data Scientist. I bridge the gap between complex data
              architectures and seamless business automation, delivering high-impact solutions
              that scale. Passionate about turning raw data into actionable intelligence.
            </motion.p>
            <motion.p {...fadeUp(0.3)} className="text-white/60 text-base leading-relaxed">
              I specialize in building robust LLM agents, predictive models, and automations
              that empower modern enterprises to operate at the speed of thought.
            </motion.p>
