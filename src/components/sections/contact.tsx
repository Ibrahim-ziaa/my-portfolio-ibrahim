...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSending(true);
    // Simulate sending — wire up your API route here
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <motion.div {...fadeUp(0.1)} className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-5">
              <a
                href="mailto:ibrahim@nebulai.com"
              ...
              >
                <div className="w-11 h-11 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-[#e53e3e]/10 group-hover:border-[#e53e3e]/30 transition-all">
                  <Github size={18} className="text-[#e53e3e]" />
                </div>
                <div>
                  <div className="text-xs text-white/40 uppercase tracking-wider mb-0.5">GitHub</div>
                  <div className="text-white text-sm font-medium group-hover:text-[#e53e3e] transition-colors">
                    github.com/ibrahim-ziaa
                  </div>
                </div>
              </a>
              ...
              >
                <div className="w-11 h-11 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-[#e53e3e]/10 group-hover:border-[#e53e3e]/30 transition-all">
                  <svg
                    viewBox="0 0 24 24"
                    className="w-4 h-4 text-[#e53e3e] fill-current"
                  >
                ...
                <div>
                  <div className="text-xs text-white/40 uppercase tracking-wider mb-0.5">Upwork</div>
                  <div className="text-white text-sm font-medium group-hover:text-[#e53e3e] transition-colors">
